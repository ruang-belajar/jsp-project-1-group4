<%-- 
    Document   : zakki.messageboard.view
    Created on : 2 Jul 2025, 11.54.21
    Author     : acer
--%>
...
<html lang="id">
    <head>
        <meta charset="UTF-8">
        <title>Message Board - Zakki</title>
    ...
    <body>
        <div class="container">
            ...
            <h2 class="text-center text-primary mb-4">💬 Message Board - Zakki Aditya</h2>
